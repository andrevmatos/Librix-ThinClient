...
from ltmt.defs import pidfile, version
...
if __name__ == "__main__":
	...
	dbg_group.add_argument("-q", "--quiet", dest="verbose", default=False,
		action="store_false", help="Suppress debug informations")
	dbg_group.add_argument("-v", "--verbose", dest="verbose", default=False,
		action="store_true", help="Show debug informations")
